...
uint64_t get_Nano_Seconds(seatimer_t timer)
{
    ...
    {
        if (frequency.QuadPart > 0) // no equals since this is used in division and
...
#    else // this function is older and more likely available if we don't have the
          // support we need/want
