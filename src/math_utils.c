...
uint64_t power_Of_Two(uint16_t exponent)
{
    ...
    default:
        ...
        //{
        //    //Since this case is 31 or higher, we can start with the value above
        //    to reduce how long this loop runs uint32_t shiftCounter =
        //    UINT64_C(30);//uint32 in case we do hit something huge in this loop
        //    and roll all the way around a uint16 result = UINT64_C(268435456);
