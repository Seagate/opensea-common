...
// \brief Defines cast macros and conversion functions for more safely converting between types.
//
#pragma once
...
extern "C"
{
    ...
    //Defining macros for static/reinterpret cast. These are mostly meant to be used in inline functions
    //in this library to make it easy to import correct code into C and C++.
    //They can be used in the library code or C++ code if you wish, but you are better off using
    //static_cast or reinterpret_cast in C++ over this macro. -TJE
    ...
    // This is especially good for C++ since you get conversion warnings and is a way to remove warnings in C++ when converting to a bool
    ...
    //There are technically 3 kinds of char, however char can be defined as signed or unsigned.
    //If you are not sure, call the char version. If you know you are using signed or unsigned
    //char, then use those versions.
