...
//! within opensea-libs
#if IS_CLANG_VERSION(3, 0)
#    define DISABLE_WARNING_OLD_STYLE_CAST _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wold-style-cast\"")
#    define RESTORE_WARNING_OLD_STYLE_CAST _Pragma("clang diagnostic pop")
#elif IS_GCC_VERSION(4, 2)
#    define DISABLE_WARNING_OLD_STYLE_CAST _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wold-style-cast\"")
