...
#        endif
#    endif
#    if !defined(M_ATTR_UNUSED) /*__has_attribute is available, but doesn't have                                       \
                                   what we need-TJE*/
#        if defined(__GNUC__) || defined(__clang__)
...
#        define M_FUNC_ATTR_MALLOC __attribute__((malloc))
#    else
#        define M_FUNC_ATTR_MALLOC    /* this function allocates memory and returns the                                \
                                         pointer to you */
#    endif
#elif defined(_Ret_opt_valid_) /* from SAL. Not exactly right, but closer to how this                                  \
                                  works for clang and gcc. There is a similar SAL                                      \
                                  annotation where you name the parameter specifying the                               \
                                  size, but I didn't want to change on the other                                       \
                                  attributes for now - TJE */
