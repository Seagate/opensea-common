...
// specializations for the supported unsigned types. Each specialization simply
// forwards to the corresponding C helper implemented above (e.g. count_leading_zeros_uc).
