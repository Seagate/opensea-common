...
//There are also wrapper macros to handle differences between Windows, C11 Annex K, and POSIX APIs so that this works "the same" on all platforms
//The functions in here provide the same parameter validation mentioned in C11 annex K
