...
// values come from
// here:https://docs.microsoft.com/en-us/cpp/preprocessor/predefined-macros?view=vs-2019
...
#define SEA_MSC_VER_VS2019_16_8                                                                                        \
    1928 //_MSC_FULL_VER needed to distinguish 16.8 and 16.9: 2019 16.8 is
         // 192829333, 2019 16.9 is 192829910
#define SEA_MSC_VER_VS2019_16_9 1928
#define SEA_MSC_VER_VS2019_16_10                                                                                       \
    1929 //_MSC_FULL_VER needed to distinguish 16.8 and 16.9: 2019 16.10 is
         // 192929917, 2019 16.11 is 192930129
...
#define SEA_MSC_VER_VS2019_17_10 1940
    ...
    //
    //! \brief   Description:  Checks if the current OS is Windows 8 or higher (this
    //! is essentially the same as what is in version_helper.h, but that file is not
    //! available to MinGW
    //
    //  Entry:
    //!
    ...
    //
    //! \brief   Description:  Checks if the current OS is Windows 8.1 or higher.
    //! This does NOT require manifesting as 8.1 or higher to work. It uses the
    //! version number in kernel32.dll
    //
    //  Entry:
    //!
    //  Exit:
    ...
    //
    //! \brief   Description:  Checks if the current OS is Windows 10 or higher.
    //! This does NOT require manifesting as 8.1 or higher to work. It uses the
    //! version number in kernel32.dll
    //
    //  Entry:
    ...
    //  is_Windows_PE()
    //
    //! \brief   Description:  Checks if the application is currently running in the
