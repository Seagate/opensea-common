...
static void test_get_And_Validate_Integer_Input_Uint32(void) {
    ...
    TEST_ASSERT(get_And_Validate_Integer_Input_Uint32("123abcf", &unit, ALLOW_UNIT_TEMPERATURE, &outputInteger), "Converted string to integer successfully");
...
static void test_get_And_Validate_Integer_Input_Uint16(void) {
    ...
    TEST_ASSERT(get_And_Validate_Integer_Input_Uint16("123abcf", &unit, ALLOW_UNIT_TEMPERATURE, &outputInteger), "Converted string to integer successfully");
...
static void test_get_And_Validate_Integer_Input_Uint8(void) {
    ...
    TEST_ASSERT(get_And_Validate_Integer_Input_Uint8("123abcf", &unit, ALLOW_UNIT_TEMPERATURE, &outputInteger), "Converted string to integer successfully");
