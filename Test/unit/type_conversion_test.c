...
static void test_M_REINTERPRET_CAST(void)
{
    ...
    TEST_ASSERT(*int_ptr == 0x12345678,
                "M_REINTERPRET_CAST should reinterpret char pointer back to int pointer correctly");
...
static void test_int8_to_sizet(void)
{
    ...
    // Test with a value greater than SIZE_MAX - Not possible for real systems as SIZE_MAX is typically much larger than
    // INT8_MAX.
    errno              = 0;
    ...
    TEST_ASSERT(sizet_overflow == 0,
                "int8_to_sizet should convert the values to int8 first for values greater than INT8_MAX");
...
static void test_int32_to_sizet(void)
{
    ...
    TEST_ASSERT(sizet_overflow == 0,
                "int32_to_sizet should convert the values to int32 first for values greater than INT32_MAX");
...
static void test_uint32_to_sizet(void)
{
    ...
    TEST_ASSERT(sizet_overflow == 0,
                "uint32_to_sizet should convert the values to uint32 first for values greater than UINT32_MAX");
}
...
static void test_uint64_to_sizet(void)
{
    ...
    TEST_ASSERT(sizet_negative == 18446744073709549616,
                "uint64_to_sizet should convert negative values to positive values");
...
static void test_ulong_to_sizet(void)
{
    ...
    TEST_ASSERT(sizet_negative == (size_t)((unsigned long)negative_val),
                "ulong_to_sizet should convert negative values to positive values");
}
...
static void test_ulonglong_to_sizet(void)
{
    ...
    TEST_ASSERT(sizet_negative == 18446744073709551611,
                "ulonglong_to_sizet should convert negative values to positive values");
}
...
static void test_to_sizet(void)
{
    ...
    TEST_ASSERT(sizet_uchar == (size_t)UCHAR_MAX,
                "to_sizet should convert unsigned char to size_t correctly using to_sizet");
    ...
    TEST_ASSERT(sizet_ushort == (size_t)USHRT_MAX,
                "to_sizet should convert unsigned short to size_t correctly using to_sizet");
    ...
    TEST_ASSERT(sizet_uint == (size_t)UINT_MAX,
                "to_sizet should convert unsigned int to size_t correctly using to_sizet");
    ...
    TEST_ASSERT(sizet_ulong == (size_t)ULONG_MAX,
                "to_sizet should convert unsigned long to size_t correctly using to_sizet");

    // Test with a valid long long value
    long long long_long_val   = LLONG_MAX;
    size_t    sizet_long_long = to_sizet(long_long_val);
    TEST_ASSERT(sizet_long_long == (size_t)LLONG_MAX,
                "to_sizet should convert long long to size_t correctly using to_sizet");
    ...
    TEST_ASSERT(sizet_ulong_long == (size_t)ULLONG_MAX,
                "to_sizet should convert unsigned long long to size_t correctly using to_sizet");
}
#endif
...
static void test_is_size_t_max(void)
{
    ...
    // Test with a value greater than SIZE_MAX - Not possible for real systems as SIZE_MAX is typically the maximum
    // value for size_t.
