...
static void test_uint8_round_up_generic(void) {
    ...
    TEST_ASSERT_EQ(uint8_round_up_generic((uint8_t)251, 10), 260, "Round 251 up to nearest multiple of 10: Overflow case");
}
...
static void test_int8_round_up_generic(void) {
    ...
    TEST_ASSERT_EQ(int8_round_up_generic(121, 10), 130, "Round 121 up to nearest multiple of 10: Overflow case");
}
...
static void test_signed_char_round_up_generic(void) {
    ...
    TEST_ASSERT_EQ(signed_char_round_up_generic(121, 10), 130, "Round 121 up to nearest multiple of 10: Overflow case");
}
...
static void test_unsigned_char_round_up_generic(void) {
    ...
    TEST_ASSERT_EQ(unsigned_char_round_up_generic((uint8_t)251, 10), 260, "Round 251 up to nearest multiple of 10: Overflow case");
}
