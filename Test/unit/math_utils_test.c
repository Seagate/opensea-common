...
static void test_int8_round_up_generic(void) {
    TEST_ASSERT_EQ(int8_round_up_generic(8, 3), 8, "Round 8 to nearest multiple of 3");
    TEST_ASSERT_EQ(int8_round_up_generic(5, 7), 7, "Round 5 to nearest multiple of 7");
    TEST_ASSERT_EQ(int8_round_up_generic(12, 2), 12, "Round 12 to nearest multiple of 9");
}
