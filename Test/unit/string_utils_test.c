...
static void test_remove_Leading_And_Trailing_Control_Char_Len(void) {
    char str[] = "\n\tHello\n\t";
    remove_Leading_And_Trailing_Control_Char_Len(str, sizeof(str));
...
static void test_convert_String_To_Lower_Case_Len(void) {
    char str[] = "HEllO World!";
    convert_String_To_Lower_Case_Len(str, sizeof(str));
...
static void test_find_last_occurrence_in_string(void) {
    ...
    const char* substr4 = "plan";
    size_t offset3 = find_last_occurrence_in_string(str, substr3);
    size_t offset4 = find_last_occurrence_in_string(substr3, substr4);
    printf("Offset for substr3 not found: %zu\n", offset3);
    printf("Offset for substr4 not found: %zu\n", offset4);
}
