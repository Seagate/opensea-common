...
static void test_safe_memset(void) {
    ...
    TEST_ASSERT(errno == EINVAL, "safe_memset should set errno to EINVAL when destsz is greater than RSIZE_MAX");
    ...
    TEST_ASSERT(errno == EINVAL, "safe_memset should set errno to EINVAL when count is greater than RSIZE_MAX");
    ...
    TEST_ASSERT(errno == EINVAL, "safe_memset should set errno to EINVAL when count is greater than destsz");
}
