...
static void test_M_GETBITRANGE(void) {
    ...
    TEST_ASSERT_EQ(M_GETBITRANGE(0xFFF00000FFF00000ULL, 63, 0), (uint64_t)(0xFFF00000FFF00000), "Extract bits 63 to 0 from 0xFFF00000FFF00000 using M_GETBITRANGE");
}
...
static void test_M_IGETBITRANGE(void) {
    ...
    TEST_ASSERT_EQ(M_GETBITRANGE(0xFFF00000FFF00000ULL, 63, 0), (int64_t)(0xFFF00000FFF00000), "Extract bits 63 to 0 from 0xFFF00000FFF00000 using M_GETBITRANGE");
}
