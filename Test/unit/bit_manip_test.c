...
static void test_get_bit_range_uint8(void) {
    ...
    printf("errno: %d, msb = 7, lsb = 8\n", errno); // Debug print to check errno value
...
static void test_get_req_bit_width_ul(void) {
    ...
    for (unsigned long i = 0; i < 33; i++) {
        ...
        snprintf(msg, sizeof(msg),
                 "The smallest number of bits needed to represent the given value is %lu",
                 32 - i);
...
static void test_bit_floor_ul(void) {
    ...
    for (unsigned long i = 0; i < 32; i++) {
        ...
        char msg[100];
        snprintf(msg, sizeof(msg),
                 "the largest integral power of two not greater than the given value is %lu",
                 expected);
...
static void test_bit_ceil_ul(void) {
    ...
    for(uint64_t i = 0; i < 10; i++) {
        char msg[100];
        snprintf(msg, sizeof(msg), "the smallest integral power of two not less than the given value is %llu", expected[i]);
