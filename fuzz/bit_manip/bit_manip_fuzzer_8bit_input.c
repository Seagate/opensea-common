...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    volatile uint8_t nibbles_To_Byte_result = nibbles_To_Byte(upperNibble, lowerNibble);
    (void)nibbles_To_Byte_result;

    volatile uint16_t bytes_To_Uint16_result = bytes_To_Uint16(msb16, lsb16);
    (void)bytes_To_Uint16_result;

    volatile uint32_t bytes_To_Uint32_result = bytes_To_Uint32(msb32, byte2_32, byte1_32, lsb32);
    (void)bytes_To_Uint32_result;

    volatile uint64_t bytes_To_Uint64_result = bytes_To_Uint64(msb64, byte6_64, byte5_64, byte4_64, byte3_64, byte2_64, byte1_64, lsb64);
